		...
		<Container>
			<View style={{ marginTop: 30, marginBottom: 20, flexDirection: "row" }}>
				...
				<View style={{ marginHorizontal: "auto" }}>
					<Text
						style={{ fontWeight: 700, fontSize: 20, color: "rgba(0,0,0, .8)" }}
					>
						Cart list
					</Text>
					<Text
			...
			>
				<Text
					style={{ paddingLeft: 1, fontSize: 18, color: "rgba(0,0,0, .4)" }}
				>
					Sub-Total:{" "}
					<Text style={{ color: "black", fontWeight: 500 }}>$3,400.00</Text>{" "}
				</Text>
				<Text style={{ fontSize: 18, color: "rgba(0,0,0, .4)" }}>
					Shipping Fee:{" "}
					<Text style={{ color: "black", fontWeight: 500 }}>$1,000.00</Text>{" "}
				</Text>
				<Text style={{ fontSize: 18, color: "rgba(0,0,0, .4)" }}>
					{" "}
				...
				<Text style={{ fontSize: 18, fontWeight: 900, color: "black" }}>
					Total:{" "}
					<Text style={{ color: "black", fontWeight: 500 }}>$3,500.00</Text>{" "}
				</Text>
			</View>
